	...
	<hr>
		...
		<form method="post" class="form-signin" style="text-align: center; margin: 0 auto;">
			<div style="text-align: left;">No:${item.bbsid}</div>
				...
				<input name="bbstitle" type="text" value="${item.bbstitle}" class="form-control" style="width:800px; height:50px;">
			</div>

		<div class="input-group mb-3">
				<label>내용</label>
				<textarea name="bbscontent" class="form-control" title="내용을 입력하세요." style="width:800px; height:300px;"><c:out value="${item.bbscontent}" />				
			</textarea>
				</div>
				
			<div style="padding-top: 10px">
				<button type="submit" class="btn btn-dark">등록</button>
				<button type="button" class="list_btn btn btn-dark" onclick="location.href='../list'">목록</button>
			</div>				
		</form>
