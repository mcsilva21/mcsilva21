...
<nav id="nav">
	...
	<div id="container">
		...
		<div class="input-group-prepend">			
				<label>과목이름:</label>
			<input name="subname" type="text" value="${item.subname}" class="form-control" 
			...
			<div class="input-group-prepend">
				<label>담당교수:</label>
				<input name="subpro" type="text" value="${item.subpro}" class="form-control" 
				aria-label="Sizing example input" 
				aria-describedby="inputGroup-sizing-default">
			</div>
			</div>	
			...
			<div class="input-group-prepend">
				<label>학점:</label>
				<input name="subpoint" type="text" value="${item.subpoint}" class="form-control" 
				aria-label="Sizing example input" 
				aria-describedby="inputGroup-sizing-default">
			</div>	
			</div>	
