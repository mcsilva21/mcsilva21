...
//	@RequestMapping(value = "/test.do", method = RequestMethod.GET)	
	...
	@ResponseBody //메서드의 반환겂 자체가 응답 데이터로 전송되어야 함을 표시 
...
//		(1)속성이름을 문자열로 표현 (2)문자열은 쌍타옴표만 사용		
//		 var obj = {now : "20220-07-22 11:42:42", 'num' :7};
		//자바스크립트객체 
		//{"now":"20220-07-22 11:42:42", 'num' :7} //JSON문자열
