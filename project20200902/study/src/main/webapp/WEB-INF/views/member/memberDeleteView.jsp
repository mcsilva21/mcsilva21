...
Security
Insights
Hassue/이소희/20200728/memberDeleteView.jsp
@bowtie0306
bowtie0306 20200728
Latest commit f55a532 1 minute ago
 History
 1 contributor
158 lines (124 sloc)  4.33 KB
...
<div class="text-center">
	<label class="white" for="userName">&nbsp &nbsp 성명 &nbsp &nbsp</label> <input
		type="text" id="userName" name="userName" value="${member.userName}"
		readonly="readonly" />
</div>
</br>
      ...
      <div class="text-center">
			<div class="form-group has-feedback">
				<button class="btn btn-primary btn-xl text-uppercase"" type="button" id="submit">회원탈퇴</button>
