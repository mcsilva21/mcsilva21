...
<form name="replyForm" method="post">
  ...
  <div>
    <label for="writer">댓글 작성자</label><input type="number" id="repwriter" name="repwriter" value="${user.stuid}"/>
    <br/>
    <label for="content">댓글 내용</label><input type="text" id="repcontent" name="repcontent" />
  </div>
  <div>
