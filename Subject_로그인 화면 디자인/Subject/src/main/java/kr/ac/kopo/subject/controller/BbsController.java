...
public class BbsController {
	...
	//댓글 작성
		...
		public String replyWrite(@PathVariable int bbsid,Reply item,RedirectAttributes rttr,HttpSession session) throws Exception {
		...
		public String replyDeleteView(@PathVariable int repno,Model model) throws Exception {
