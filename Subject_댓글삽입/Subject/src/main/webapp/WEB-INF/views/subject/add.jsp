	...
	<div id="container">
		...
		<form method="post" class="form-signin">
			...
			<div class="input-group-prepend">
				<label>강의명:</label>
				<input name="subname" type="text" class="form-control" aria-label="Sizing example input" 
			...
			<div class="input-group-prepend">
				<label>담당교수:</label>
				<input name="subpro" type="text" class="form-control" aria-label="Sizing example input" 
				aria-describedby="inputGroup-sizing-default">
			</div>
			</div>
			<div class="input-group mb-3">
			<div class="input-group-prepend">
				<label>학점:</label>
				<input name="subpoint" type="text" class="form-control" aria-label="Sizing example input" 
				aria-describedby="inputGroup-sizing-default">
			</div>	
			</div>		
