	...
	<div id="container" style="margin: 0 auto; text-align: center;">	
		<form method="post" class="form-signin">
			<div style="text-align: center; margin: 0 auto;">
				<label>과목이름</label>
			<input name="subname" type="text" value="${item.subname}" class="form-control" style="width: 500px; margin: 0 auto;">
			</div>
			<div>			
				<label>담당교수</label>
				<input name="subpro" type="text" value="${item.subpro}" class="form-control" style="width:500px; margin: 0 auto;">
			</div>
			<div>		
				<label>학점</label>
				<input name="subpoint" type="text" value="${item.subpoint}" class="form-control" style="width: 500px; margin: 0 auto;">
			</div>
