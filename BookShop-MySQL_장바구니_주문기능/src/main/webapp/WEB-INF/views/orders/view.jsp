	...
	<div>
		<table border="1">
			...
			<tr>
				...
				<td colspan="3"><fmt:formatNumber pattern="#,###" value="${item.saleprice}"/></td>
			</tr>
				<tr>
				<td colspan="2">구매일자</td>
				<td colspan="3"><fmt:formatDate pattern="yyyy-MM-dd" value="${item.orderdate}"/></td>
			...
			<tr>
				...
				<td>${item.amount}</td>
				<td><fmt:formatNumber pattern="#,###" value="${item.price * item.amount}"/></td>
			</tr>
			</c:forEach>
