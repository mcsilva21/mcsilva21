  ...
  <header class="masthead" style="background-image: url('/resources/img/home-bg.jpg')">
	...
	<div id="container" style="margin: 0 auto; text-align: center;">	
		...
		<div style="text-align: center; margin: 0 auto;">				
				<label>고객명</label>
				<input name="stuname" type="text" value="${item.stuname}" class="form-control" style="width: 500px; margin: 0 auto;">
			</div>
		<div>	
			<label>비밀번호</label>
				<input name="stupass" type="text" value="${item.stupass}" class="form-control" style="width:500px; margin: 0 auto;">
			</div>

			<div>
				<label>부서</label>
				<input name="studepart" type="text" value="${item.studepart}" class="form-control" style="width: 500px; margin: 0 auto;">				
			</div>
