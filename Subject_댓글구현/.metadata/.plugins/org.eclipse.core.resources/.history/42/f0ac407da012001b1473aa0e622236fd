	...
	<div id="container" style="margin: 0 auto; text-align: center;">				
		<form method="post" class="form-signin">
			<div style="text-align: center; margin: 0 auto;">
				<label>강의명</label>
				<input name="subname" type="text" class="form-control" style="width: 500px; margin: 0 auto;">
			</div>
			<div>				
				<label>담당교수</label>
				<input name="subpro" type="text" class="form-control" style="width: 500px; margin: 0 auto;">
			</div>
			<div>
				<label>학점</label>
				<input name="subpoint" type="text" class="form-control" style="width: 500px; margin: 0 auto;">
			</div>	
